...
function SavedCard({job}) {
  ...
  return (
     ...
     <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
       ...
       <div onClick={()=>toggleBookmark()} className="text-2xl text-white cursor-pointer hover:text-gray-400">
          {bookmarked ? <FaBookmark color='#FF4B4B' size={25} /> : <FaRegBookmark color='#FF4B4B' size={25}/>}
